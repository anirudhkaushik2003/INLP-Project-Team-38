...
python3 main.py --arch vanilla --batch_size 2  --epochs 10 --corpus gcdc   --gpus 4 --task minority-classification --checkpoint_path /ssd_scratch/cvit/anirudhkaushik/inlp_project_models/ --online_mode 1
